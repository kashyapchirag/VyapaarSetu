...
const Navbar = () => {
    ...
    return (
        <nav className="z-5 fixed w-full right-0 left-0 px-10 py-1 pt-2 bg-[#F3F6FF] dark:bg-[#0F172A]">
            <ul className="flex justify-between h-[10%] gap-10">
                <div className="flex justify-center items-center gap-3 text-[#1E3A8A] dark:text-[#E2E8F0] text-[1.1rem] font-extrabold">
                    <img src="/src/assets/logo3.png" className="h-8 my-auto md:h-12" alt="VyapaarSetu-logo" />
