const CTAsection = () => {
    return (
        <div className='hidden relative md:flex md:flex-col md:items-center md:gap-10 lg:items-start bg-linear-to-r from-[#EAF0FF] to-[#DCE6FF] dark:from-[#1E293B] dark:to-[#0F172A] w-full rounded-2xl p-15 md:mt-7 md:mb-7 lg:mt-35 lg:mb-35 shadow-xl'>
            <div className="left md:flex flex-col gap-5 w-3/4">
                <h1 className='text-[#1E3A8A] dark:text-[#E2E8F0] text-5xl font-bold'>Get started with VyapaarSetu.</h1>
            ...
            <img className='lg:absolute hidden lg:block bottom-20 right-20 w-55 h-auto' src="/src/assets/phoneView.png" alt="phone-snippet" />
